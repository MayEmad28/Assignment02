...
import 'routeAppButton.dart';

import 'courseScreen.dart';

class routeApp extends StatelessWidget{
  static const routeName='routeApp';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor:Color.fromRGBO(16, 74, 210,1) ,
      ...
      body: ListView(
        children: [
          ...
          routeAppButton(text: 'ANDROID COURSE',onButtonCliked:navigateToScreen,path:'assets/images/Android.jpeg',
              courseText: '''Part 1 ( Java SE)
...
• one signal push notifications SDK
 '''),
         Container(
          ...
          routeAppButton(text: 'IOS COURSE',onButtonCliked:navigateToScreen,path: 'assets/images/IOS.jpeg',
              courseText: ''' OOP refreshment
• Introduction
...
• Creating final project depends on attendees needs'''),
         ...
         routeAppButton(text: 'FULLSTACK COURSE',onButtonCliked:navigateToScreen,path: 'assets/images/fullStack.jpeg',
             courseText: ''' •HTML	
•HTML 5 
•CSS
•CSS3
...
'''),
   ...
   navigateToScreen(BuildContext context,String path,String course){
  SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>courseScreen(imagepath: path,courseText: course,)));
  });
  }
}